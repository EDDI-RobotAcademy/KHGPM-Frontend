<template>
    <v-container>
      <div align="center">
        <h2>상품 수정</h2>
        <!-- board 변수가 존재할 때에만 jpa-board-modify-form 컴포넌트가 렌더링  -->
  ...
  import JpaProductModifyForm from '@/components/lecture/board/JpaProductModifyForm.vue'
      ...
      methods: {
          ...
          async onSubmit (payload) {    
            ...
            // payload : JpaProductModifyForm 컴포넌트에서 실행된 수정된 데이터가 넘어와있다.
              ...
              await this.requestProductModifyToSpring({ ProductId, title, content, writer })
